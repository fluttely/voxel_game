// flutter_scene 0.23.0's test/noise_test.dart, less its curl and baking groups:
// the pinned values prove the copied FastNoiseLite is the same noise.
import 'package:test/test.dart';
import 'package:voxel_engine/src/worldgen/noise/fast_noise_lite.dart';
